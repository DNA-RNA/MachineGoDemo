...
namespace WebAPI.Controllers
{
    ...
    public class MachineTypesController : ControllerBase
    {
        ...
        [HttpPut("update")]
        public IActionResult Update(MachineType machineType)
        {
            var result = _machineTypeService.Update(machineType);
            if (result.Success)
            {
                return Ok(result);
            }
        ...
        [HttpDelete("delete")]
        public IActionResult Delete(MachineType machineType)
        {
            var result = _machineTypeService.Delete(machineType);
            if (result.Success)
            {
                return Ok(result);
            }
